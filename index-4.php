            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-md-6 col-lg-12">
                    <div class="auction-item-6" data-aos="zoom-out-up" data-aos-duration="1200">
                        <div class="auction-inner">
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/trending/auction-1.png" alt="trending"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h5 class="title"><a href="product-details.php">2016 KIA Optima, EX</a></h5>
                ...
                <div class="col-md-6 col-lg-12">
                    <div class="auction-item-6" data-aos="zoom-out-up" data-aos-duration="1300">
                        <div class="auction-inner">
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/trending/auction-2.png" alt="trending"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h5 class="title"><a href="product-details.php">2019 Polaris General, 1000 Eps</a></h5>
                                <div class="item-information">
                                    <ul>
                                        <li><span>Number</span>1-38005900</li>
                                        <li><span>VIN</span>2G1WG5EK3B1312245</li>
                ...
                <div class="col-md-6 col-lg-12">
                    <div class="auction-item-6" data-aos="zoom-out-up" data-aos-duration="1400">
                        <div class="auction-inner">
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/trending/auction-3.png" alt="trending"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h5 class="title"><a href="product-details.php">2018 Hyundai Elantra, Sel/Value/Limited</a></h5>
                                <div class="item-information">
                                    <ul>
                                        <li><span>Number</span>1-38005900</li>
                                        <li><span>VIN</span>2G1WG5EK3B1312245</li>
                ...
                <div class="col-md-6 col-lg-12">
                    <div class="auction-item-6" data-aos="zoom-out-up" data-aos-duration="1500">
                        <div class="auction-inner">
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/trending/auction-4.png" alt="trending"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h5 class="title"><a href="product-details.php">2018 Toyota Camry, L/Le/Xle/Se/Xse</a></h5>
                                <div class="item-information">
                                    <ul>
                                        <li><span>Number</span>1-38005900</li>
                                        <li><span>VIN</span>2G1WG5EK3B1312245</li>
                ...
                <div class="row justify-content-center mb-40-none">
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="800">
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/ending/auction01.png" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                                    <a href="product-details.php">2024 Honda Insight, 
                                        Touring</a>
                                </h6>
                                <div class="bid-amount">
                                    <div class="icon">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="800">
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/ending/auction02.png" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                                    <a href="product-details.php">2011 Hyundai Sonata,
                                        Se/Limited</a>
                                </h6>
                                <div class="bid-amount">
                                    <div class="icon">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="800">
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/ending/auction03.png" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                                    <a href="product-details.php">2016 Dodge Grand
                                        Caravan, Sxt</a>
                                </h6>
                                <div class="bid-amount">
                                    <div class="icon">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="800">
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/ending/auction04.png" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                                    <a href="product-details.php">2009 Jeep Wrangler
                                        Unlimite, Sahara</a>
                                </h6>
                                <div class="bid-amount">
                                    <div class="icon">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="800">
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/ending/auction05.png" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                    ...
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="800">
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/ending/auction06.png" alt="ending"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                                    <a href="product-details.php">2019 Indian Motorcycle
                                        Co. Scout, Bobber</a>
                                </h6>
                                <div class="bid-amount">
                                    <div class="icon">
                    ...
                    <div class="col-sm-6 col-lg-3" data-aos="fade-down" data-aos-duration="1800">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="066e636a764663686169726e636b632865696b">[email&#160;protected]</span></a>
                                </li>
                                <li>
