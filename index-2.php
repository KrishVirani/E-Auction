        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1000">
                        <div class="auction-thumb">
                            <a href="product-details.php"><img src="assets/images/auction/car/auction-1.jpg" alt="jewelry"></a>
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1000">
                        <div class="auction-thumb">
                            <a href="product-details.php"><img src="assets/images/auction/watches/auction-2.jpg" alt="jewelry"></a>
                            <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                        </div>
                        <div class="auction-content">
                ...
                <div class="auction-wrapper-5">
                    <div class="auction-item-5 time" data-aos="fade-down" data-aos-duration="1100">
                        <div class="auction-inner">
                            ...
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/upcoming/upcoming-1.png" alt="upcoming"></a>
                                <a href="product-details.php" class="rating"><i class="far fa-star"></i></a>
                            </div>
                            <div class="auction-content">
                    ...
                    <div class="auction-item-5 live" data-aos="zoom-out-up" data-aos-duration="1200">
                        <div class="auction-inner">
                            ...
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/upcoming/upcoming-2.png" alt="upcoming"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            </div>
                            <div class="auction-content">
                                <div class="title-area">
                                    <h6 class="title">
                                        <a href="product-details.php">14k Gold Geneve Watch,24.5g</a>
                                    </h6>
                                    <div class="list-area">
                                        <span class="list-item">
                                            <span class="list-id">Listing ID</span>14033488
                    ...
                    <div class="auction-item-5 buy" data-aos="zoom-out-down" data-aos-duration="1400">
                        <div class="auction-inner">
                            ...
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/upcoming/upcoming-3.png" alt="upcoming"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            </div>
                            <div class="auction-content">
                                <div class="title-area">
                                    <h6 class="title">
                                        <a href="product-details.php">2009 Toyota Prius (Medford, NY 11763)</a>
                                    </h6>
                                    <div class="list-area">
                                        <span class="list-item">
                                            <span class="list-id">Listing ID</span>14033488
                    ...
                    <div class="auction-item-5 time" data-aos="fade-down" data-aos-duration="1200">
                        <div class="auction-inner">
                            ...
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/upcoming/upcoming-4.png" alt="upcoming"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            </div>
                            <div class="auction-content">
                                <div class="title-area">
                                    <h6 class="title">
                                        <a href="product-details.php">Canon EOS Rebel T6I Digital Camera</a>
                                    </h6>
                                    <div class="list-area">
                                        <span class="list-item">
                                            <span class="list-id">Listing ID</span>14033488
                    ...
                    <div class="auction-item-5 buy" data-aos="zoom-out-down" data-aos-duration="1400">
                        <div class="auction-inner">
                            ...
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/upcoming/upcoming-5.png" alt="upcoming"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            </div>
                            <div class="auction-content">
                                <div class="title-area">
                                    <h6 class="title">
                                        <a href="product-details.php">14K White Gold 185.60 Grams 5.95 Carats.....</a>
                                    </h6>
                                    <div class="list-area">
                                        <span class="list-item">
                                            <span class="list-id">Listing ID</span>14033488
                    ...
                    <div class="auction-item-5 live" data-aos="zoom-out-up" data-aos-duration="1200">
                        <div class="auction-inner">
                            ...
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/upcoming/upcoming-6.png" alt="upcoming"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            </div>
                            <div class="auction-content">
                                <div class="title-area">
                                    <h6 class="title">
                                        <a href="product-details.php">.6 Gram Pure Gold Nugget</a>
                                    </h6>
                                    <div class="list-area">
                                        <span class="list-item">
                                            <span class="list-id">Listing ID</span>14033488
                    ...
                    <div class="auction-item-5 time" data-aos="fade-down" data-aos-duration="1300">
                        <div class="auction-inner">
                            ...
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/upcoming/upcoming-7.png" alt="upcoming"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            </div>
                            <div class="auction-content">
                                <div class="title-area">
                                    <h6 class="title">
                                        <a href="product-details.php">Magnifying Glasses, Jewelry Loupe...</a>
                                    </h6>
                                    <div class="list-area">
                                        <span class="list-item">
                                            <span class="list-id">Listing ID</span>14033488
                    ...
                    <div class="auction-item-5 live" data-aos="zoom-out-up" data-aos-duration="1200">
                        <div class="auction-inner">
                            ...
                            <div class="auction-thumb">
                                <a href="product-details.php"><img src="assets/images/auction/upcoming/upcoming-8.png" alt="upcoming"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                            </div>
                            <div class="auction-content">
                                <div class="title-area">
                                    <h6 class="title">
                                        <a href="product-details.php">"Small Primitive Shell" Glass Sculpture</a>
                                    </h6>
                                    <div class="list-area">
                                        <span class="list-item">
                                            <span class="list-id">Listing ID</span>14033488
                    ...
                    <div class="col-sm-6 col-lg-3" data-aos="fade-down" data-aos-duration="1800">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="59313c3529193c373e362d313c343c773a3634">[email&#160;protected]</span></a>
                                </li>
                                <li>
