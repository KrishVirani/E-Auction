                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-8" data-aos="zoom-out-down" data-aos-duration="1100">
                        <div class="auction-thumb">
                            ...
                            <a href="product-details.php" class="thumb-area bg_img" data-background="assets/images/auction/featured/auction-1.png"></a>
                        </div>
                        <div class="auction-content">
                            <div class="title-area">
                                <h6 class="title">
                                    <a href="product-details.php">4402 NW 47th St, Tamarac</a>
                                </h6>
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-8" data-aos="zoom-out-down" data-aos-duration="1200">
                        <div class="auction-thumb">
                            ...
                            <a href="product-details.php" class="thumb-area bg_img" data-background="assets/images/auction/featured/auction-2.png"></a>
                        </div>
                        <div class="auction-content">
                            <div class="title-area">
                                <h6 class="title">
                ...
                <div class="col-sm-10 col-md-6 col-lg-4">
                    <div class="auction-item-8" data-aos="zoom-out-down" data-aos-duration="1300">
                        <div class="auction-thumb">
                            ...
                            <a href="product-details.php" class="thumb-area bg_img" data-background="assets/images/auction/featured/auction-3.png"></a>
                        </div>
                        <div class="auction-content">
                            <div class="title-area">
                                <h6 class="title">
                    ...
                    <div class="col-sm-6 col-lg-3" data-aos="fade-down" data-aos-duration="1800">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="234b464f5363464d444c574b464e460d404c4e">[email&#160;protected]</span></a>
                                </li>
                                <li>
